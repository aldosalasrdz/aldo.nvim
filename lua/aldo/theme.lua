local colors = require "aldo.colors"
local config = require "aldo.config"
...
M.base = {
  ...
  CursorLineNr = { fg = colors.white, bg = colors.bg, style = "bold" },
  ...
  IncSearch = { fg = colors.pink, bg = colors.bg },
  ...
  PmenuSel = { bg = colors.visual_select_bg },
  ...
  Visual = { fg = "NONE", bg = colors.visual_select_bg },
